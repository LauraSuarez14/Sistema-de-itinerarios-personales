...
estilo que los demás servicios (dataclass congelado + os.getenv), pero sin
Vault: el gateway no maneja secretos propios más allá del JWT_SECRET_KEY que
ya comparte con el resto del sistema vía common.security."""
